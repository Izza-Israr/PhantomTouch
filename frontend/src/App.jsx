  ...
  return (
    <>
      ...
      <header className={`nav-header ${token && screen === 'dashboard' ? 'nav-header-dashboard' : ''}`}>
        ...
        >
          <img src="/logo.png" alt="PhantomTouch" className="header-logo" />
          <span style={{
          ...
          {token ? (
            <>
              <div className="nav-links hidden-mobile">
                <button
                  type="button"
                  className={`nav-link ${dashboardView === 'overview' ? 'active' : ''}`}
                ...
                <button
                  type="button"
                  className={`nav-link ${dashboardView === 'sessions' ? 'active' : ''}`}
                ...
                <button
                  type="button"
                  className={`nav-link ${dashboardView === 'statistics' ? 'active' : ''}`}
                ...
                <button
                  type="button"
                  className={`nav-link ${dashboardView === 'profile' ? 'active' : ''}`}
              ...
              <div className="header-user-block">
                <span className="user-badge"><span className="user-dot" />{profile?.fullName || user?.email}</span>
                <button
